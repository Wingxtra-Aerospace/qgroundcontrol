...
- Visual tuning is runtime-configurable from **Application Settings -> Fly View -> 3D View** (`Vehicle Icon Scale`, `Trail Thickness Scale`, `Mission Color Intensity`) and does not require rebuilding.
