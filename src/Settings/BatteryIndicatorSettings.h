...
public:
    ...
    DEFINE_SETTINGFACT(cellCountOverride)       // Operator override for battery cell count, 0 = auto
    ...
    Q_INVOKABLE void setCellCountOverride(int value);

private:
    void validateThreshold1();
    void validateThreshold2(); 
    void validateCellCountOverride();
    void _threshold1Changed();
    void _threshold2Changed();
    void _cellCountOverrideChanged();
};
