...
PreFlightCheckButton {
    ...
    property var    _batteryValue:                  _batteryGroup ? (!isNaN(_batteryGroup.displayPercentRemaining.value) ? _batteryGroup.displayPercentRemaining.value : _batteryGroup.percentRemaining.value) : 0
